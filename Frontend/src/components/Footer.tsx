...
import { FaTwitter, FaFacebookF, FaYoutube, FaEnvelope, FaShieldAlt } from 'react-icons/fa';
      ...
      <div className="container mx-auto px-4">
            ...
            <ul className="space-y-2 flex flex-col items-center lg:items-start">
              ...
              <li>
                <a href="https://youtube.com" target="_blank" rel="noopener noreferrer"
                  ...
                  <FaYoutube className="text-lg group-hover:scale-125 group-hover:-rotate-12 transition-transform duration-300" />
                  <span>YouTube</span>
                </a>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-200 mt-8 pt-6">
          <div className="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
            <p className="text-gray-500 text-xs">&copy; {new Date().getFullYear()} KiddoVase. All rights reserved.</p>
