  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      >
        <script type="application/ld+json">{`{
          ...
          "mainEntity": [
            {
              "@type": "Question",
              "name": "How does KiddoVase protect children online?",
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "KiddoVase uses AI-powered content moderation, chat filtering, and privacy tools to ensure a safe and positive environment."
              }
            },
            {
              "@type": "Question",
              "name": "Can parents control what their child sees?",
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "Yes, KiddoVase provides comprehensive parental controls to manage what children can access and who can contact them."
              }
            }
          ]
        }`}</script>
      ...
      <main className="container mx-auto px-4 py-8 flex-grow">
        ...
        <section aria-label="Safety Tips" className="mb-12">
        ...
        <section aria-label="Parental Controls" className="mb-12">
