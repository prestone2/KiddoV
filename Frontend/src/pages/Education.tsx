...
const Education = () => {
  ...
  const subjects = [
    ...
    },
    {
      title: "Game Design",
      description:
        "Explore creativity, storytelling, and user experience design",
      image:
        "https://images.unsplash.com/photo-1511512578047-dfb367046420?auto=format&fit=crop&q=80&w=400&h=200",
      lessons: 12,
    },
    {
      title: "Digital Citizenship",
      description:
        "Learn about online safety, ethics, and responsible behavior",
      image:
        "https://images.unsplash.com/photo-1488590528505-98d2b5aba04b?auto=format&fit=crop&q=80&w=400&h=200",
      lessons: 8,
    },
  ];
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <Seo
        ...
        description="Discover how Kiddovase uses games to nurture skills like creativity, problem-solving, teamwork, and digital literacy — empowering children to learn through play in a safe space."
        keywords="learning through play, educational gaming, kids education, fun learning, digital literacy for children"
        canonicalUrl="https://kiddovase.com/education"
      />
      ...
      <div className="container mx-auto px-4 py-8 flex-grow">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Empower the next generation with hands-on learning experiences that
            inspire creativity, collaboration, and computational thinking.
          </p>
        </div>
        ...
        <div className="text-center bg-roblox-light-gray rounded-lg p-8">
          ...
          <p className="text-gray-600 mb-6">
            Join thousands of educators bringing creative learning to their
            classrooms.
          </p>
