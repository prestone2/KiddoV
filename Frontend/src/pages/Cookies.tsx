      ...
      <main className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="space-y-8">
            ...
            <div className="space-y-6">
              ...
              <div className="border-l-4 border-primary pl-4">
                ...
                <p className="text-muted-foreground">
                  ...
                  authentication, and accessibility features. These cannot be
                  disabled.
                </p>
                <div className="mt-2 text-sm text-muted-foreground">
                  <p>
                    <strong>Examples:</strong> Login sessions, security tokens,
                    consent preferences
                  </p>
                  <p>
              ...
              <div className="border-l-4 border-secondary pl-4">
                ...
                <p className="text-muted-foreground">
                  ...
                  by collecting and reporting information anonymously. This
                  helps us improve our site performance and user experience.
                </p>
                <div className="mt-2 text-sm text-muted-foreground">
                  <p>
              ...
              <div className="border-l-4 border-destructive pl-4">
                ...
                <p className="text-muted-foreground">
                  ...
                  relevant advertisements. They may be set by advertising
                  partners through our site.
                </p>
                <div className="mt-2 text-sm text-muted-foreground">
                  <p>
                    <strong>Examples:</strong> Ad targeting, conversion
                    tracking, social media pixels
                  </p>
                  <p>
                    <strong>Duration:</strong> Up to 1 year
                  </p>
            ...
            <div className="space-y-4 text-muted-foreground">
              ...
              <div className="grid md:grid-cols-2 gap-4 mt-4">
                <div className="bg-background/50 p-4 rounded-lg">
                  ...
                  <p className="text-sm">
                    Helps us understand website usage and improve user
                    experience.
                  </p>
                </div>
                <div className="bg-background/50 p-4 rounded-lg">
                  ...
                  <p className="text-sm">
                    Enables social sharing and embedded content from social
                    platforms.
                  </p>
                </div>
                <div className="bg-background/50 p-4 rounded-lg">
                  ...
                  <p className="text-sm">
                    Secure processing of payments and subscription management.
                  </p>
                </div>
                <div className="bg-background/50 p-4 rounded-lg">
                  <h4 className="font-semibold text-foreground mb-2">
                  ...
                  <p className="text-sm">
                    Live chat and help desk functionality for user support.
                  </p>
                </div>
              </div>
            </div>
          ...
          <section className="bg-card/50 p-6 rounded-lg">
            ...
            <div className="space-y-4 text-muted-foreground">
              <p>
                You have control over how cookies are used on our website. Here
                are your options:
              </p>
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <p>
                    ...
                    through their settings menu. You can usually find this under
                ...
                <div>
                  ...
                  <p>
                    When you first visit our site, you can choose to accept all
                    cookies or reject non-essential ones through our cookie
                    consent banner.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p>
                    ...
                    through the service provider's website or through industry
                    opt-out tools.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-amber-500/10 border border-amber-500/20 p-4 rounded-lg mt-6">
                ...
                <p className="text-amber-700 dark:text-amber-300 text-sm">
                  ...
                  website and limit your ability to use some features. Essential
                  cookies cannot be disabled as they are necessary for the site
                  to work.
                </p>
              </div>
            </div>
