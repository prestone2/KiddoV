...
const Help = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <Seo
        title="Help & Support"
        description="Need help using Kiddovase? Get expert support for games, parental settings, and safety controls to ensure your child’s experience stays positive and secure."
        keywords="help, support, kids safety, games assistance, parental help"
